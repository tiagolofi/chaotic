...
with col1_3:
    ...
    with st.expander('Stats (P1)'):
        ...
        elem1 = st.data_editor(pandas.DataFrame({1: {'Elementos': ', '.join(data1['elements'])}}), key = 'd3')
...
with col2_1:
    ...
    with st.expander('Stats (P2)'):
        ...
        elem2 = st.data_editor(pandas.DataFrame({1: {'Elementos': ', '.join(data2['elements'])}}), key = 'd4')
