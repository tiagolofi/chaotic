...
with col1_3:
    ...
    value_debit = st.number_input('Debit (P1)', min_value = 0, step = 1)

    value_credit = st.number_input('Credit (P1)', min_value = 0, step = 1)
...
with col2_1:
    ...
    value_debit2 = st.number_input('Debit (P2)', min_value = 0, step = 1)

    value_credit2 = st.number_input('Credit (P2)', min_value = 0, step = 1)
